...
import { RemovenotedComponent } from '../../../../components/removenoted/removenoted.component';
...
export class NotedComponent implements OnInit {
  ...
  removeNoted(e: Event,word: string): void {
    e.stopPropagation();
    const data = { username: this.store.username, word: word }
